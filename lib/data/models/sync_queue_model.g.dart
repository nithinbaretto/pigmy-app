...
const SyncQueueModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'entityType': PropertySchema(
      ...
      name: r'entityType',
      type: IsarType.string,
      enumMap: _SyncQueueModelentityTypeEnumValueMap,
    ),
...
SyncQueueModel _syncQueueModelDeserialize(
  ...
  object.action =
      _SyncQueueModelactionValueEnumMap[reader.readStringOrNull(offsets[0])] ??
          SyncAction.create;
  object.createdAt = reader.readDateTime(offsets[1]);
  object.entityId = reader.readString(offsets[2]);
  object.entityType = _SyncQueueModelentityTypeValueEnumMap[
...
P _syncQueueModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 3:
      return (_SyncQueueModelentityTypeValueEnumMap[
              reader.readStringOrNull(offset)] ??
          SyncEntityType.collection) as P;
    case 4:
...
const _SyncQueueModelentityTypeEnumValueMap = {
  r'collection': r'collection',
  r'transaction': r'transaction',
};
const _SyncQueueModelentityTypeValueEnumMap = {
  r'collection': SyncEntityType.collection,
  r'transaction': SyncEntityType.transaction,
};
...
extension SyncQueueModelQuerySortBy
  ...
  QueryBuilder<SyncQueueModel, SyncQueueModel, QAfterSortBy> sortByEntityId() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncQueueModel, SyncQueueModel, QAfterSortBy> sortByLastError() {
    return QueryBuilder.apply(this, (query) {
...
extension SyncQueueModelQuerySortThenBy
  ...
  QueryBuilder<SyncQueueModel, SyncQueueModel, QAfterSortBy> thenByEntityId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'entityId', Sort.asc);
    });
  }
  ...
  QueryBuilder<SyncQueueModel, SyncQueueModel, QAfterSortBy> thenByLastError() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastError', Sort.asc);
    });
  }
...
extension SyncQueueModelQueryWhereDistinct
  ...
  QueryBuilder<SyncQueueModel, SyncQueueModel, QDistinct> distinctByEntityId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncQueueModel, SyncQueueModel, QDistinct> distinctByEntityType(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncQueueModel, SyncQueueModel, QDistinct> distinctByLastError(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncQueueModel, SyncQueueModel, QDistinct> distinctByPayloadJson(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension SyncQueueModelQueryProperty
  ...
  QueryBuilder<SyncQueueModel, String, QQueryOperations> entityIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'entityId');
    });
  }

  QueryBuilder<SyncQueueModel, SyncEntityType, QQueryOperations>
      entityTypeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncQueueModel, String?, QQueryOperations> lastErrorProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'lastError');
    });
  }

  QueryBuilder<SyncQueueModel, String, QQueryOperations> payloadJsonProperty() {
    return QueryBuilder.apply(this, (query) {
