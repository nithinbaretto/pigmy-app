...
const TransactionModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'collectionTypeCode': PropertySchema(
      id: 2,
      name: r'collectionTypeCode',
      type: IsarType.string,
    ),
  ...
  indexes: {
    ...
    r'collectionTypeCode': IndexSchema(
      id: 4074551166359628202,
      name: r'collectionTypeCode',
      unique: false,
      replace: false,
      properties: [
...
int _transactionModelEstimateSize(
  ...
  bytesCount += 3 + object.collectionTypeCode.length * 3;
...
void _transactionModelSerialize(
  ...
  writer.writeString(offsets[2], object.collectionTypeCode);
  ...
  writer.writeDateTime(offsets[8], object.transactionDate);
}
...
TransactionModel _transactionModelDeserialize(
  ...
  object.collectionTypeCode = reader.readString(offsets[2]);
  object.customerName = reader.readString(offsets[3]);
  object.id = id;
  object.isSynced = reader.readBool(offsets[4]);
  object.referenceNumber = reader.readStringOrNull(offsets[5]);
  object.serverId = reader.readString(offsets[6]);
  object.status = _TransactionModelstatusValueEnumMap[
          reader.readStringOrNull(offsets[7])] ??
      TransactionStatus.pending;
  object.transactionDate = reader.readDateTime(offsets[8]);
  return object;
}
...
extension TransactionModelQueryWhereSort
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterWhere> anyIsSynced() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionModelQueryWhere
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterWhereClause>
      collectionTypeCodeEqualTo(String collectionTypeCode) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'collectionTypeCode',
        value: [collectionTypeCode],
      ));
    });
  }

  QueryBuilder<TransactionModel, TransactionModel, QAfterWhereClause>
      collectionTypeCodeNotEqualTo(String collectionTypeCode) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
              indexName: r'collectionTypeCode',
              lower: [],
              upper: [collectionTypeCode],
              includeUpper: false,
            ))
            .addWhereClause(IndexWhereClause.between(
              indexName: r'collectionTypeCode',
              lower: [collectionTypeCode],
              includeLower: false,
              upper: [],
            ));
      } else {
...
extension TransactionModelQueryFilter
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      collectionTypeCodeEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'collectionTypeCode',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      collectionTypeCodeContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'collectionTypeCode',
        value: value,
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterFilterCondition>
      collectionTypeCodeMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'collectionTypeCode',
        wildcard: pattern,
...
extension TransactionModelQuerySortBy
  ...
  QueryBuilder<TransactionModel, TransactionModel, QAfterSortBy>
      sortByCollectionTypeCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'collectionTypeCode', Sort.asc);
    });
  }

  QueryBuilder<TransactionModel, TransactionModel, QAfterSortBy>
      sortByCollectionTypeCodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'collectionTypeCode', Sort.desc);
    });
  }
...
extension TransactionModelQueryWhereDistinct
  ...
  QueryBuilder<TransactionModel, TransactionModel, QDistinct>
      distinctByCollectionTypeCode({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'collectionTypeCode',
          caseSensitive: caseSensitive);
    });
  }
...
extension TransactionModelQueryProperty
  ...
  QueryBuilder<TransactionModel, String, QQueryOperations>
      collectionTypeCodeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'collectionTypeCode');
    });
  }
